...
(function ( $, window, document, undefined ) {
    ...
    $.extend(Plugin.prototype, {
        ...
        resetClasses: function(){
            this.$handle.removeClass(this.options.openClass).removeClass(this.options.closedClass);
            this.$collapsible.removeClass(this.options.openClass).removeClass(this.options.closedClass);
            this.$el.removeClass(this.options.openClass).removeClass(this.options.closedClass);
        },
        ...
        addResizeListener: function(){
            ...
            $(window).bind('resize', function(e){
                ...
                //prevent from false ios resize events
...
})( jQuery, window, document );;var menus = {
    'feedback':{
