 ...
 *
 */
class HCLI_BootstrapCli extends Zend_Application_Bootstrap_Bootstrap {
    /**
     *
    ...
    protected function _initCliFrontController() {        
        ...
        $request = new HCLI_Controller_Request_Cli($getopt);
        $front->setResponse(new Zend_Controller_Response_Cli)
                ->setRequest($request)
                ->setRouter(new HCLI_Controller_Router_Cli)
