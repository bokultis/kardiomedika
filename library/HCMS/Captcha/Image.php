 ...
 * @copyright  Horisen
 */
class HCMS_Captcha_Image extends Zend_Captcha_Image {
    protected $_bgColor = array(
        'R' => 255,
        'G' => 255,
        'B' => 255
    );
    ...
    protected function _generateImage($id, $word)
    {
        ...
        $text_color = imagecolorallocate($img, $this->_textColor['R'], $this->_textColor['G'], $this->_textColor['B']);
        $bg_color   = imagecolorallocate($img, $this->_bgColor['R'], $this->_bgColor['G'], $this->_bgColor['B']);
       ...
       // generate noise
        ...
        $bg_color = imagecolorallocate($img2, $this->_bgColor['R'], $this->_bgColor['G'], $this->_bgColor['B']);
