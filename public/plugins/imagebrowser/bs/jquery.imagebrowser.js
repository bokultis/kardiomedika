...
(function($)
{
    ...
    $.fn.imagebrowser = function(options)
    {
        ...
        return this.each(function()
        {
            ...
            $.loadTpl(opts.template,function(tplStr){
                ...
                //Toolbar
                self.find(".ibToolbar button.crop, #ibPanel button.crop").click(function cropClick(){
                    $(this).blur();
                    if(jcropApi == null){
                        return false;
                    }
                ...
                $("#ibResize").find("#okButton").click(function(){
                ...
                self.find(".ibToolbar button.resize").click(function resizeClick(){
                    $(this).blur();

                    //set starting dimensions
                    var dims = {
                        width: $('#ibPreview img').data('width'),
                        height: $('#ibPreview img').data('height')
                    }
                    if(opts.cropBox[0]){
                ...
                //PREVIEW
                self.find(".ibToolbar button.preview").click(function previewClick(){
                    //show crop clip
                    $("#ibCropClip").show();
                    $('#ibCropPreview img').show();
                    $("#ibCropPreview").modal('show');
                    return false;
                });
    ...
    {
        'template':'/plugins/imagebrowser/bs/template.tpl',
        'initPath':'/',
