...
(function($) 
{
	...
	{
            //for err disable autoclose and make dialog modal
            if(options && options.clsName == 'err'){
		...
		$("#fmBox").addClass(opts.clsName).css("opacity",1.0).fadeIn(opts.fadeIn,function()
		{
			...
			{
				$("#fmBox").append("<a href='javascript:void(0);'><div id='closeBtn'></div></a>");
	...
	$.flashMessenger.init = function(msg,opts)
	{
		...
		$("body").append("<div id='fmOverlay'></div>");
		$("#fmOverlay").css("opacity",0.0);
		
		$("body").append("<div class='fmBox' id='fmBox'></div>");
