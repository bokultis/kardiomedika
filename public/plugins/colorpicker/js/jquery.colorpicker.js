			...
			init: function (opt) {
				...
				return this.each(function () {
					if (!$(this).data('colorpickerId')) {
						...
						var submitButton = cal.find('.colorpicker_submit');
						submitButton.bind('mouseenter', enterSubmit)
							.bind('mouseleave', leaveSubmit)
							.bind('click', clickSubmit);
						submitButton.text(options.submitText || 'Done');
...
(function($)
{
     ...
     */
    $.fn.ColorPickerWidget = function(options)
    {

        // return the object back to the chained call flow
        return this.each(function()
        {
            $(this).after('<span class="colorpicker-box"></span>');
            var $this = $(this);
            var val = $this.val();
